...
function MakeScriptHub()
         loadstring(game:HttpGet('https://raw.githubusercontent.com/SimmyDepvai/Z-axureLoader/main/HuyGamingNewVietSub.lua'))() --Put The Script That Will Load If The Key Is Correct Here
end
